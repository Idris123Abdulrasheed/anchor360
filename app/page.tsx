      ...
      <section className="relative z-10 w-full max-w-md">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-3">
            <div className="w-11 h-11 rounded-full bg-[#406882] flex items-center justify-center shadow-md">
        ...
        <div className="bg-white/90 backdrop-blur-xl rounded-[32px] shadow-2xl border border-[#eadccb] px-8 py-10">
          <div className="mx-auto w-24 h-24 rounded-full bg-gradient-to-br from-[#B85C2D] to-[#1F3A5F] flex items-center justify-center shadow-xl mb-7">
          ...
          <p className="text-center text-[#406882] font-bold tracking-[0.22em] text-xs mt-3 mb-8">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full rounded-2xl border border-gray-200 bg-white py-4 px-5 flex items-center justify-center gap-3 text-gray-800 font-semibold shadow-sm hover:shadow-lg hover:border-[#1F3A5F] transition-all active:scale-[0.98] disabled:opacity-70"
          >
            {isLoading ? (
